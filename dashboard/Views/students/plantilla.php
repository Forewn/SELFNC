...
$this->Image('../../Assets/img/logo.png',250,15,25);
...
$this->Cell(40, 8, utf8_decode('Listado de estudiantes'));
...
$pdf->Cell(30, 12, utf8_decode('Nacimiento'),1,0,'C',1);
...
$stmt = $connect->prepare("SELECT * FROM estudiantes");
